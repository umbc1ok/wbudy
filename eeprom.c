                    ...
                    tU16 address)
{
    ...
    if (retCode == I2C_CODE_OK)
    {
      ...
      while (1)
      {
        ...
        if ((status == (tU8)0x18) || (status == (tU8)0x28))
        {
          ...
          /* Write data */
          retCode = i2cPutChar((tU8)(address & (tU8)0xff));
          while (retCode == I2C_CODE_BUSY)
          {
            retCode = i2cPutChar((tU8)(address & (tU8)0xff));
          }
  ...
  {
    /* Write SLA+R */
    retCode = i2cPutChar(devAddr + (tU8)0x01);
    while (retCode == I2C_CODE_BUSY)
    {
      retCode = i2cPutChar(devAddr + (tU8)0x01);
    }
                ...
                tU16 len)
{
  ...
  do
  {
    ...
    retCode = i2cWriteWithWait((tU8)(addr & (tU8)0xFF));
    if (retCode != I2C_CODE_OK)
    {
      break;
    }
...
tS8 pca9532(tU8 *pBuf, tU16 len, tU8 *pBuf2, tU16 len2)
{
  ...
  if (len2 > (tU16)0)
  {
    ...
    {
      /* wait until address transmitted and receive data */
      for (i = (tU16)1; i <= len2; i = i + (tU16)1)
      {
        /* wait until data transmitted */
        while (1)
        {
